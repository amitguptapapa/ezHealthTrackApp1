...
public class PrintRadiologyOrderedActivity extends EzPrint {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_print_radiology_ordered);
		...
		txtRadiologyOrdered = (TextView) findViewById(R.id.txt_radiology_ordered);
		...
		try {
			...
			PatientController.patientBarcode(
					PrintRadiologyOrderedActivity.this, new OnResponseData() {
