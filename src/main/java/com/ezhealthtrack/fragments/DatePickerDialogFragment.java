...
/**
 * <p>
 * This class provides a usable {@link DatePickerDialog} wrapped as a
 * {@link DialogFragment}, using the compatibility package v4. Its main
 * advantage is handling Issue 34833 automatically for you.
 * </p>
 * 
 * <p>
 ...
 * <li>Buttons labeled from {@code android.R.string.ok} and
 ...
 * @version 2012.0828
 * @see <a
 *      href="http://code.google.com/p/android/issues/detail?id=34833">Android
 *      Issue 34833</a>
 * @see <a href="http://stackoverflow.com/q/11444238/489607" >Jelly Bean
 *      DatePickerDialog — is there a way to cancel?</a>
 * 
 */
public class DatePickerDialogFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		// Disable past dates and display from today's date only {
		...
		if (hasJellyBeanAndAbove()) {
			picker.setButton(DialogInterface.BUTTON_POSITIVE, getActivity()
					.getString(android.R.string.ok),
					new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
							DatePicker dp = picker.getDatePicker();
							mListener.onDateSet(dp, dp.getYear(),
									dp.getMonth(), dp.getDayOfMonth());
						}
					});
			picker.setButton(DialogInterface.BUTTON_NEGATIVE, getActivity()
