...
import com.ezhealthtrack.adapter.EzGridFragmentAdaptor;
import com.ezhealthtrack.controller.EzController;
import com.ezhealthtrack.controller.EzController.UpdateListner;

public abstract class EzGridFragment extends Fragment implements UpdateListner {

	// view
	protected GridView mGridView;
	protected EzGridFragmentAdaptor mGridAdapter;
	...
	public EzGridFragment(boolean offline) {
	...
	public void onCreateListView(View parent, LayoutInflater inflater) {
		...
		mGridView = (GridView) parent.findViewById(R.id.list_patients);
	...
	// mController.getPage(page, mUrlParams, null);
	// }
	// }
	// }
