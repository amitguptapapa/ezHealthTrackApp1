 ...
 * DAO for table LABS.
*/
public class LabsDao extends AbstractDao<Labs, Long> {

    public static final String TABLENAME = "LABS";

    /**
     * Properties of entity Labs.<br/>
    ...
    */
    ...
    public LabsDao(DaoConfig config) {
        super(config);
    }
    
    public LabsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'LABS' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'LABS'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Labs entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Labs readEntity(Cursor cursor, int offset) {
        Labs entity = new Labs( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Labs entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Labs entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Labs entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
