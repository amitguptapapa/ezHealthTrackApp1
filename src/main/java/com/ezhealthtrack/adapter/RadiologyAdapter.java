...
public class RadiologyAdapter extends ArrayAdapter<Appointment> implements
		Filterable {
	...
	Filter filter = new Filter() {
		...
		protected void publishResults(final CharSequence constraint,
			...
			try {
				RadiologyAdapter.objects.clear();
				RadiologyAdapter.objects
	...
	public RadiologyAdapter(final Context context, final int resourceId,
			final ArrayList<Appointment> item) {
		super(context, resourceId, RadiologyAdapter.objects);
		sharedPref = context.getSharedPreferences(Constants.EZ_SHARED_PREF,
				Context.MODE_PRIVATE);
		this.context = context;
		confirmedList = item;
		RadiologyAdapter.objects.clear();
		RadiologyAdapter.objects.addAll(item);
	...
	public View getView(final int position, final View convertView,
		...
		View row = null;
		try {
			final Appointment rowItem = RadiologyAdapter.objects.get(position);
			if (convertView == null) {
