...
public class LabsLabTestsAdapter extends ArrayAdapter<LabTest> {
	Context context;
	Activity activity;

	public LabsLabTestsAdapter(Context context, int resourceId,
			List<LabTest> item) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final LabTest rowItem = getItem(position);
